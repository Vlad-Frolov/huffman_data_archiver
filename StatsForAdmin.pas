...
type
  TStatsForm = class(TForm)
    ...
    procedure btnSearchRecClick(Sender: TObject);
  private
...
{ Действия при нажатии кнопки "Поиск"}
procedure TStatsForm.btnSearchRecClick(Sender: TObject);
begin
